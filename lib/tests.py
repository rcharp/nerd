...
def login(client, username='', password=''):
    ...
    response = client.post(url_for('api.login'), data=user,
...
def logout(client):
    """
    Log a specific api out.

    :param client: Flask client
    :return: Flask response
    """
    return client.get(url_for('api.logout'), follow_redirects=True)
